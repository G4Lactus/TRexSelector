...
typename MemoryMappedMatrix<Scalar>::MapType MemoryMappedMatrix<Scalar>::getMap() {
    ...
    return MapType(reinterpret_cast<Scalar*>(mapped_region_->get_address()), rows_, cols_);
}

template<typename Scalar>
typename MemoryMappedMatrix<Scalar>::ConstMapType MemoryMappedMatrix<Scalar>::getMap() const {
    return ConstMapType(reinterpret_cast<const Scalar*>(mapped_region_->get_address()), rows_, cols_);
}
...
Scalar* MemoryMappedMatrix<Scalar>::data() {
    ...
    return reinterpret_cast<Scalar*>(mapped_region_->get_address());
}
