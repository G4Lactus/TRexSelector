...
class LpNormScaler:
    def __init__(self, norm_type: NormType = ..., with_mean: bool = True) -> None:
        ...
    def fit(self, X: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], threshold: typing.SupportsFloat | typing.SupportsIndex = 1e-12) -> LpNormScaler:
        ...
    def get_dropped_indices(self) -> list[int]:
        ...
    def get_means(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
        ...
    ...
    def get_with_norm(self) -> bool:
        ...
    def inverse_transform_inplace(self, X_normed: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        ...
    ...
    def save(self, filename: str) -> None:
        ...
    def transform_inplace(self, X: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        ...
class NormType:
    """
    Members:
...
class ZScoreScaler:
    def __init__(self, with_mean: bool = True, with_std: bool = True) -> None:
        ...
    def fit(self, X: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"], threshold: typing.SupportsFloat | typing.SupportsIndex = 1e-12) -> ZScoreScaler:
        ...
    def get_dropped_indices(self) -> list[int]:
        ...
    def get_means(self) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, 1]"]:
    ...
    def get_with_std(self) -> bool:
        ...
    def inverse_transform_inplace(self, X_scaled: typing.Annotated[numpy.typing.ArrayLike, numpy.float64, "[m, n]"]) -> typing.Annotated[numpy.typing.NDArray[numpy.float64], "[m, n]"]:
        ...
    def is_fitted(self) -> bool:
        ...
    def load(self, filename: str) -> None:
