...
int main() {
    ...
    if (false)
    {
        ...
        constexpr int max_gap = 15;  // max gap for capped spread support
        ...
        // TRex and DA control parameters
        ...
        auto m = evaluate_selection("AR(1) DA+AR1",
