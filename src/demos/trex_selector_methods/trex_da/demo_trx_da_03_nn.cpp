// ==============================================================================
// demo_trx_da_03_nn.cpp
// ==============================================================================
/**
 * @file demo_trx_da_03_nn.cpp
 *
 * @brief DA-TRex demo and MC simulation for the nearest-neighbours (NN) DGP.
 *
 * @details
 *  Part 1: Single-run demo (n=150, p=500, s=5, kappa=3, rho=0.7, SNR=2.0).
...
int main() {
    ...
    // ══════════════════════════════════════════════════════════════════════════
    {
        ...
        run_snr_sweep(
            ...
            "NN kappa=3, rho=0.7, n=" + std::to_string(cfg.n)
