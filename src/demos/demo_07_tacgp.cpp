...
void demo_TACGP_early_stopping(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    TACGP_Solver tacgp(X_aug_map, y_map, num_dummies,
                      /*normalization=*/true,
                      /*intercept=*/true,
                      /*verbose=*/true
                    );
...
void demo_TACGP_serialization() {
    ...
    // Print Demo Header
    cdiagnost::print_section_header("=== Demo 3: T-ACGP Serialization & Path Consistency ===");
...
void demo_04_memory_mapped(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    const std::string X_aug_file = "demo_tacgp_X_aug.bin";
...
int main() {
    ...
    try {
        ...
        demo_TACGP_with_external_normalizer(/*high_dim=*/false, /*rnd_coef=*/false, /*T_stop=*/10);
        demo_TACGP_with_external_normalizer(/*high_dim=*/true, /*rnd_coef=*/false, /*T_stop=*/10);
