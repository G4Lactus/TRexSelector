...
// ============================================================================
/**
 * @file demo_01_tlars.cpp
 *
 * @brief Demonstration of T-LARS (Terminating Least Angle Regression) solver.
 *
 * @details Shows basic usage, extrernal/internal normalization, serialization,
...
void demo_TLARS_early_stopping(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    TLARS_Solver tlars(X_aug_map, y_map, num_dummies,
                      /*normalization=*/true,
                      /*intercept=*/true,
                      /*verbose=*/true
                    );
...
void demo_TLARS_serialization() {
    ...
    // Print Demo Header
    cdiagnost::print_section_header("=== Demo 3: T-LARS Serialization & Path Consistency ===");
...
void demo_04_memory_mapped(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    const std::string X_aug_file = "demo_tlars_X_aug.bin";
...
int main() {
    ...
    try {
        ...
        demo_TLARS_with_external_normalizer(/*high_dim=*/false, /*rnd_coef=*/false, /*T_stop=*/10);
        demo_TLARS_with_external_normalizer(/*high_dim=*/true, /*rnd_coef=*/false, /*T_stop=*/10);
