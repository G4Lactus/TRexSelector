...
void demo_TENET_early_stopping(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    TENET_Solver tenet(X_aug_map, y_map, num_dummies, lambda2,
                      /*normalization=*/true,
                      /*intercept=*/true,
                      /*verbose=*/true
                    );
...
void demo_04_memory_mapped(bool high_dim, bool rnd_coef, std::size_t T_stop) {
    ...
    const std::string X_aug_file = "demo_tenet_X_aug.bin";
...
int main() {
    ...
    try {
        ...
        demo_TENET_with_external_normalizer(/*high_dim=*/false, /*rnd_coef=*/false, /*T_stop=*/10);
        demo_TENET_with_external_normalizer(/*high_dim=*/true, /*rnd_coef=*/false, /*T_stop=*/10);
