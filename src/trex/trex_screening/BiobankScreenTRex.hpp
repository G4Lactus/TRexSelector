/**
 * @file BiobankScreenTRex.hpp
 * @brief Genomics biobank screening with Algorithm 1 from Scree-TRex paper.
 *
 * Coordinates Screen-TRex and T-Rex selectors for efficient large-scale phenotype screening.
 */

#ifndef BIOBANK_SCREEN_TREX_HPP
#define BIOBANK_SCREEN_TREX_HPP
...
struct BiobankScreenTRexControl {
    ...
    /**
     * @brief Control parameters for Screen-TRex selector.
     */
    ScreenTRexControlParameter screen_ctrl;

    /**
     * @brief Control parameters for fallback T-Rex selector.
     */
...
#endif /* End of BIOBANK_SCREEN_TREX_HPP */
