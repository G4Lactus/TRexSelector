...
void demo_TGP_early_stopping(bool high_dim, std::size_t T_stop = 5) {

    std::cout << "=== Demo 1: Basic T-GP with Early Stopping ===\n";
...
void demo_TGP_with_external_normalizer(bool high_dim, std::size_t T_stop = 5) {

    std::cout << "=== Demo 2: T-GP with External Normalization ===\n";
...
void demo_TGP_serialization() {
    ...
    std::cout << "=== Demo 3: T-GP Serialization & Path Consistency ===\n\n";
...
void demo_TGP_controlled_comparison() {
    ...
    // ============================================================
    // Step 5: Run T-GP for both versions
    // ============================================================
    std::cout << "\n=== Step 5: Running T-GP on in-memory data ===\n";
    TGP_Solver tgp_inmem(X_aug_inmem_map, y_inmem_map, num_dummies, false, false, true);
    tgp_inmem.executeStep(T_stop, true);
    std::cout << "  ✓ In-memory T-GP complete\n\n";

    std::cout << "Running T-GP on memory-mapped data...\n";
    TGP_Solver tgp_mmap(X_aug_mmap_map, y_mmap_map, num_dummies, false, false, true);
    tgp_mmap.executeStep(T_stop, true);
    std::cout << "  ✓ Memory-mapped T-GP complete\n\n";
    ...
    auto path_inmem = tgp_inmem.getActions();
    auto path_mmap = tgp_mmap.getActions();

    std::cout << "In-memory path:\n  ";
    utils_talgos::print_selection(tgp_inmem, true_support);

    std::cout << "\nMemory-mapped path:\n  ";
    utils_talgos::print_selection(tgp_mmap, true_support);
...
// ============================================================================
// Demo 5: Production T-GP Workflow
// ============================================================================

void demo_production_tgp_workflow() {
    ...
    std::cout << "T-GP completed in " << t1.time_ms << " ms\n\n";
