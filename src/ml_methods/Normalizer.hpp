 ...
 * @file Normalizer.hpp
 *
 * @brief Declaration of the Normalizer class for L1/L2 normalization and centering.
 *
 */
// ===================================================================================

#ifndef TREX_ML_METHODS_NORMALIZER_HPP
#define TREX_ML_METHODS_NORMALIZER_HPP
...
public:
    ...
    void transform_inplace(
        Eigen::Map<Eigen::MatrixXd>& X) const override;
     ...
     */
    void inverse_transform_inplace(
        Eigen::Map<Eigen::MatrixXd>& X_normed) const override;
    ...
    const Eigen::VectorXd& get_means() const noexcept override {
        return means_;
    }

    /** @brief Get column scales or norms */
    const Eigen::VectorXd& get_scales() const noexcept override {
        return norms_;
    }
...
#endif /* TREX_ML_METHODS_NORMALIZER_HPP */
