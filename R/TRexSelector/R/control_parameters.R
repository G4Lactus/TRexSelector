...
#' @param lloop_strategy L-loop strategy: "HCONCAT" or "PERMUTATION" (default: "HCONCAT").
...
#'   \code{"Holtsmark"}, \code{"Triangle"}, \code{"UniformSphere"},
...
#'   \code{"Gumbel"}, \code{"Holtsmark"}, \code{"Logistic"}).
...
trex_dummy_distribution <- function(type     = "Normal",
  ...
  valid_types <- c("Normal", "Uniform", "Rademacher", "StudentT",
                   "Laplace", "Gumbel", "Holtsmark", "Triangle",
